const apiKey = import.meta.env.VITE_LONGCAT_API_KEY as string;

if (!apiKey) {
  console.error('Missing VITE_LONGCAT_API_KEY environment variable. Please add it to your Vercel project settings.');
}
